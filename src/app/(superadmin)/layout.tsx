...
export default function SuperAdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { name: "User Management", path: "/superadmin/dashboard", icon: Users },
  ];
            ...
            return (
              <button
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold tracking-wide transition-all cursor-pointer ${
                  isActive
                    ? "bg-gradient-to-r from-lcu-blue-vibrant/25 to-lcu-blue-light/10 text-slate-900 border border-lcu-blue-light/35 shadow-md shadow-lcu-blue-light/5"
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 px-4 py-3.5 rounded-xl text-sm font-bold tracking-wide transition-all ${
                      isActive
                        ? "bg-gradient-to-r from-lcu-blue-vibrant/20 to-lcu-blue-light/10 text-slate-900 border border-lcu-blue-light/35"
